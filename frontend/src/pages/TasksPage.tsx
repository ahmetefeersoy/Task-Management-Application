        ...
        <div className="bg-white rounded-lg shadow-xl border border-gray-200 p-6 max-w-sm">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-gray-600 mb-6">
              Are you sure you want to add this task? <br />
            </p>

            <div className="flex gap-3 justify-center">
              <button
                className="inline-flex justify-center px-4 py-2 text-sm font-medium text-white bg-green-600 border border-transparent rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors"
                onClick={async () => {
                  toast.dismiss(t.id);
                  setIsLoading(true);
                  try {
                ...
                <div className="flex items-start space-x-3 flex-1">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-1">
                      ...
                      {/* Priority Badge */}
                      <span
                        className={`px-3 py-1 text-xs rounded-full font-medium ml-3 ${
                          task.priority === "HIGH"
